...
public final class PatientHandoverAuditSupport {
	
	private PatientHandoverAuditSupport() {
	}
	
	public static void record(PatienthandoverService service, String type, String batchKey, String handoverUuid,
	        String taskUuid, boolean successful, String details) {
		try {
